 ...
 *
 */
bool LogicFactory::Create(const std::string & path, const std::string & name)
{
 ...
 *
 */
bool LogicFactory::CreateCmake(const std::string & path, const std::string & name)
{
 ...
 *
 */
bool LogicFactory::CreateMain(const std::string & path, const std::string & name)
{
 ...
 *
 */
bool LogicFactory::CreateModule(const std::string & path, const std::string & name)
{
	std::string headerDir{ };
	std::string sourceDir{ };
