...
namespace tinyToolkit
{
	 ...
	 *
	 */
	PatternLogLayout::PatternLogLayout(std::string pattern) : _pattern(std::move(pattern))
	{
	 ...
	 *
	 */
	void PatternLogLayout::Format(const LogEvent & event, std::string & value, char flag)
	{
		switch (flag)
		{
