...
#define TINY_TOOLKIT_PLATFORM_INTEL		3
#define TINY_TOOLKIT_PLATFORM_SOLARIS	4
#define TINY_TOOLKIT_PLATFORM_WINDOWS	5
#define TINY_TOOLKIT_PLATFORM_FREE_BSD	6
