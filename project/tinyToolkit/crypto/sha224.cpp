...
namespace tinyToolkit
{
	 ...
	 *
	 */
	void SHA224::Append(const char * value)
	{
		if (value == nullptr)
		{
			return;
	 ...
	 *
	 */
	void SHA224::Append(const uint8_t * value)
	{
		if (value == nullptr)
		{
			return;
	 ...
	 *
	 */
	void SHA224::Append(const std::string & value)
	{
	 ...
	 *
	 */
	void SHA224::Append(const char * value, std::size_t length)
	{
	 ...
	 *
	 */
	void SHA224::Append(const uint8_t * value, std::size_t length)
	{
		if (value == nullptr || length == 0)
		{
			return;
	 ...
	 *
	 */
	void SHA224::Append(const std::string & value, std::size_t length)
	{
	 ...
	 *
	 */
	void SHA224::Update(Context & context, const uint8_t * value, uint32_t length)
	{
