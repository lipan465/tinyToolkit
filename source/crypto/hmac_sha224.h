#ifndef __TINY_TOOLKIT__CRYPTO__HMAC_SHA224__H__
#define __TINY_TOOLKIT__CRYPTO__HMAC_SHA224__H__
...
namespace tinyToolkit
{
	namespace crypto
	{
		class TINY_TOOLKIT_API HMAC_SHA224
		{
		...
		private:
			...
			uint8_t _digest[TINY_TOOLKIT_SHA224_DIGEST_SIZE]{ 0 };
...
#endif // __TINY_TOOLKIT__CRYPTO__HMAC_SHA224__H__
