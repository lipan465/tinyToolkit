...
namespace tinyToolkit
{
	...
	public:
		 ...
		 *
		 */
		explicit MD5(const char * value) : MD5()
		{
			if (value)
			{
				Update(value);
		 ...
		 *
		 */
		explicit MD5(const uint8_t * value) : MD5()
		{
			if (value)
			{
				Update(value);
		 ...
		 *
		 */
		explicit MD5(const std::string & value) : MD5()
		{
			Update(value);
		}
		 ...
		 *
		 */
		explicit MD5(const char * data, std::size_t size) : MD5()
		{
			if (data)
			{
				Update(data, size);
		 ...
		 *
		 */
		explicit MD5(const uint8_t * data, std::size_t size) : MD5()
		{
			if (data)
			{
				Update(data, size);
		 ...
		 *
		 */
		explicit MD5(const std::string & data, std::size_t size) : MD5()
		{
			Update(data, size);
		}
