#ifndef __TINY_TOOLKIT__CRYPTO__HMAC_SHA1__H__
#define __TINY_TOOLKIT__CRYPTO__HMAC_SHA1__H__
...
{
	class TINY_TOOLKIT_API HMAC_SHA1
	{
		typedef struct
		{
...
#endif // __TINY_TOOLKIT__CRYPTO__HMAC_SHA1__H__
