...
namespace tinyToolkit
{
	 ...
	 *
	 */
	std::string Time::FormatElapsedString(std::time_t seconds)
	{
		std::time_t dayVal = 0;
	 ...
	 *
	 */
	std::string Time::FormatMillisecondElapsedString(std::time_t  milliseconds)
	{
		std::time_t dayVal = 0;
		std::time_t hourVal = 0;
		std::time_t minuteVal = 0;
	 ...
	 *
	 */
	std::string Time::FormatMicrosecondElapsedString(std::time_t  microseconds)
	{
		std::time_t dayVal = 0;
		std::time_t hourVal = 0;
		std::time_t minuteVal = 0;
