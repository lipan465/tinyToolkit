...
# 拉取fmt
#
git clone https://github.com/fmtlib/fmt.git fmt_linux_64
...
# 创建并进入目录
#
mkdir -p fmt_linux_64/build && cd fmt_linux_64/build
...
# 创建并进入目录
#
mkdir -p tinyToolkit_linux_64 && cd tinyToolkit_linux_64
