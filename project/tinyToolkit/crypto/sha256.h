...
namespace tinyToolkit
{
	...
	public:
		 ...
		 *
		 */
		explicit SHA256(const char * value);
		 ...
		 *
		 */
		explicit SHA256(const uint8_t * value);
		 ...
		 *
		 */
		explicit SHA256(const std::string & value);
		 ...
		 *
		 */
		explicit SHA256(const uint8_t * data, std::size_t size);
		 ...
		 *
		 */
		explicit SHA256(const std::string & data, std::size_t size);
