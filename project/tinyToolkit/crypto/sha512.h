...
namespace tinyToolkit
{
	...
	public:
		 ...
		 *
		 */
		explicit SHA512(const char * value);
		 ...
		 *
		 */
		explicit SHA512(const uint8_t * value);
		 ...
		 *
		 */
		explicit SHA512(const std::string & value);
		 ...
		 *
		 */
		explicit SHA512(const char * data, std::size_t size);
		 ...
		 *
		 */
		explicit SHA512(const uint8_t * data, std::size_t size);
		 ...
		 *
		 */
		explicit SHA512(const std::string & data, std::size_t size);
